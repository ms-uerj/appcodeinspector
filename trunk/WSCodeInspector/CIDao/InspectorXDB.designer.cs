...
namespace CIDao
{
    ...
    partial void DeleteTrechoDefeito(TrechoDefeito instance);
		...
		public InspectorXDBDataContext() : 
				base(global::CIDao.Properties.Settings.Default.CodeInspectorConnectionString2, mappingSource)
		{
			OnCreated();
		}
    ...
    partial void OnT_IDChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_IT_Nome", DbType="NVarChar(MAX)")]
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_IT_Descricao", DbType="NVarChar(MAX)")]
	...
	public partial class Partida : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private System.Nullable<int> _P_PONTUCAO_TOTAL;
    ...
    partial void OnP_PONTUCAO_TOTALChanging(System.Nullable<int> value);
    partial void OnP_PONTUCAO_TOTALChanged();
    #endregion
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_P_PONTUCAO_TOTAL", DbType="Int")]
		public System.Nullable<int> P_PONTUCAO_TOTAL
		{
			get
			{
				return this._P_PONTUCAO_TOTAL;
			}
			set
			{
				if ((this._P_PONTUCAO_TOTAL != value))
				{
					this.OnP_PONTUCAO_TOTALChanging(value);
					this.SendPropertyChanging();
					this._P_PONTUCAO_TOTAL = value;
					this.SendPropertyChanged("P_PONTUCAO_TOTAL");
					this.OnP_PONTUCAO_TOTALChanged();
				}
			}
		}
    ...
    partial void OnQ_NomeChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_Q_Nome", DbType="NVarChar(MAX)")]
