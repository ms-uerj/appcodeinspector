...
internal class _Super_WebServiceMain extends com.adobe.fiber.services.wrapper.WebServiceWrapper
{
    ...
    public function _Super_WebServiceMain()
    {
        ...
        operation = new mx.rpc.soap.mxml.Operation(null, "getTrechosArtefato");
        operation.resultElementType = valueObjects.TrechoRespostaEntity;
        operations["getTrechosArtefato"] = operation;
        ...
        operation = new mx.rpc.soap.mxml.Operation(null, "GetQuestoesTrechos");
        operation.resultElementType = valueObjects.QuestaoEntity;
        operations["GetQuestoesTrechos"] = operation;
        ...
        operation = new mx.rpc.soap.mxml.Operation(null, "getUsuarioByTrecho");
        operation.resultElementType = valueObjects.UsuarioEntity;
        operations["getUsuarioByTrecho"] = operation;
        ...
        operation = new mx.rpc.soap.mxml.Operation(null, "setTrechoRespostaAval");
        operations["setTrechoRespostaAval"] = operation;
    ...
    {
    	return "http://189.122.81.94:8181/webserviceacess_deploy/WebService/WebServiceMain.asmx?wsdl";
    }
    ...
    /**
      * This method is a generated wrapper used to call the 'getTrechosArtefato' operation. It returns an mx.rpc.AsyncToken whose
      * result property will be populated with the result of the operation when the server response is received.
      * To use this result from MXML code, define a CallResponder component and assign its token property to this method's return value.
      * You can then bind to CallResponder.lastResult or listen for the CallResponder.result or fault events.
      *
      ...
      * @return an mx.rpc.AsyncToken whose result property will be populated with the result of the operation when the server response is received.
      */
    public function getTrechosArtefato(questao_id:int, partida_id:int) : mx.rpc.AsyncToken
    {
        model_internal::loadWSDLIfNecessary();
        var _internal_operation:mx.rpc.AbstractOperation = _serviceControl.getOperation("getTrechosArtefato");
        var _internal_token:mx.rpc.AsyncToken = _internal_operation.send(questao_id,partida_id) ;
        return _internal_token;
    }
    ...
    /**
      * This method is a generated wrapper used to call the 'GetQuestoesTrechos' operation. It returns an mx.rpc.AsyncToken whose
      * result property will be populated with the result of the operation when the server response is received.
      * To use this result from MXML code, define a CallResponder component and assign its token property to this method's return value.
      * You can then bind to CallResponder.lastResult or listen for the CallResponder.result or fault events.
      *
      ...
      * @return an mx.rpc.AsyncToken whose result property will be populated with the result of the operation when the server response is received.
      */
    public function GetQuestoesTrechos(partida_id:int) : mx.rpc.AsyncToken
    {
        model_internal::loadWSDLIfNecessary();
        var _internal_operation:mx.rpc.AbstractOperation = _serviceControl.getOperation("GetQuestoesTrechos");
    ...
    /**
      * This method is a generated wrapper used to call the 'getUsuarioByTrecho' operation. It returns an mx.rpc.AsyncToken whose
      * result property will be populated with the result of the operation when the server response is received.
      * To use this result from MXML code, define a CallResponder component and assign its token property to this method's return value.
      * You can then bind to CallResponder.lastResult or listen for the CallResponder.result or fault events.
      *
      ...
      * @return an mx.rpc.AsyncToken whose result property will be populated with the result of the operation when the server response is received.
      */
    public function getUsuarioByTrecho(trecho:String, it_id:int, partida_id:int) : mx.rpc.AsyncToken
    {
        model_internal::loadWSDLIfNecessary();
        var _internal_operation:mx.rpc.AbstractOperation = _serviceControl.getOperation("getUsuarioByTrecho");
        var _internal_token:mx.rpc.AsyncToken = _internal_operation.send(trecho,it_id,partida_id) ;
        return _internal_token;
    }
    ...
    /**
      ...
      * @return an mx.rpc.AsyncToken whose result property will be populated with the result of the operation when the server response is received.
      */
    public function setTrechoResposta(trechoResposta:ArrayCollection, partida_id:int, user_id:int, duracao:Number) : mx.rpc.AsyncToken
    {
        model_internal::loadWSDLIfNecessary();
        var _internal_operation:mx.rpc.AbstractOperation = _serviceControl.getOperation("setTrechoResposta");
        var _internal_token:mx.rpc.AsyncToken = _internal_operation.send(trechoResposta,partida_id,user_id,duracao) ;
        return _internal_token;
    }
     
    /**
      * This method is a generated wrapper used to call the 'setTrechoRespostaAval' operation. It returns an mx.rpc.AsyncToken whose
      * result property will be populated with the result of the operation when the server response is received.
      * To use this result from MXML code, define a CallResponder component and assign its token property to this method's return value.
      * You can then bind to CallResponder.lastResult or listen for the CallResponder.result or fault events.
      *
      ...
      * @return an mx.rpc.AsyncToken whose result property will be populated with the result of the operation when the server response is received.
      */
    public function setTrechoRespostaAval(trecho:String, q_id:int, it_id:int, partida_id:int, pontos:int) : mx.rpc.AsyncToken
    {
        model_internal::loadWSDLIfNecessary();
        var _internal_operation:mx.rpc.AbstractOperation = _serviceControl.getOperation("setTrechoRespostaAval");
        var _internal_token:mx.rpc.AsyncToken = _internal_operation.send(trecho,q_id,it_id,partida_id,pontos) ;
        return _internal_token;
    }
